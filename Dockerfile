...
RUN apt-get update && apt-get -y install zip unzip pandoc jq libicu-dev=57.1-6+deb9u4 icu-devtools=57.1-6+deb9u4 && docker-php-ext-configure intl && docker-php-ext-install intl && rm -rf /var/lib/apt/lists/*
